...
class ClientTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCanInjectResponseForFutureError()
    {
        ...
        $client = new Client(['handler' => $mock]);
        $called = 0;
        $response = $client->get('https://tdm.nghelpers.com:123/foo', [
            'future' => true,
            'events' => [
    ...
    public function testCanReturnFutureResults()
    {
        ...
        $mock = new MockHandler($future);
        $client = new Client(['handler' => $mock]);
        $response = $client->get('https://tdm.nghelpers.com:123/foo', ['future' => true]);
    ...
    public function testThrowsExceptionsWhenDereferenced()
    {
        ...
        try {
            $res = $client->get('https://tdm.nghelpers.com:123/foo', ['future' => true]);
            $res->wait();
    ...
    public function testThrowsExceptionsSynchronously()
    {
        ...
        $client->get('https://tdm.nghelpers.com:123/foo');
    }
    ...
    public function testReturnsFutureForErrorWhenRequested()
    {
        ...
        $request = $client->createRequest('GET', 'https://tdm.nghelpers.com:123/foo', [
            'future' => true
        ]);
