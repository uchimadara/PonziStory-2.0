...
class CI_Email {
	...
	var	$smtp_host		= SMTP_SERVER; //"ssl://smtp.gmail.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= SMTP_USERNAME; //""admin@passive-earner.com";		// SMTP Username
	var	$smtp_pass		= SMTP_PASSWORD; //""5tgb0okm";		// SMTP Password
	var	$smtp_port		= SMTP_PORT; //""25";		// SMTP Port
