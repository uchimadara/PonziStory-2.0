		...
		<div class="row">
            ...
            <div class="col-sm-8 col-md-8">
                ...
                <div class="col-sm-12 col-md-12">
                    ...
                    <div class="col-md-5">
                    <p style="font-size:16px; text-align: center;" class="currentimebackgroundset" id="Currenttime">Current Time  : <?php echo $webtasks['CurrentDateAndTime']; ?></p>
                    </div>
                </div>
                ...
                <?php foreach($webtasks['admin_webtasks'] as $webtaskss): ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <?php if($webtasks['timepending'] === '1'): ?>
                            <div >
                                <p style="font-size:16px;" class="timeleftclass">Current Task Will Be Ended At <?php  echo $webtasks['timetoendtask']; ?></p>
                            </div>
                        <?php endif; ?>
                ...
                <form>
                    <input type="hidden" name="timeoflasttask" id="timeoflasttask" value="<?php echo $webtasks['timeoftaskinserted']; ?>">
                </form>
