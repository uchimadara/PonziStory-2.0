...
<html>
<head>
<title><?php echo $edit['websitename']; ?></title>
    ...
    <aside id="sidebar">
        ...
        <div class="side-widgets overflow">
            ...
            <div class="text-center s-widget m-b-15" id="profile-menu">
                ...
                <h2 class="username tile"><?php echo $edit['username']; ?></h2>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="col-md-12">
                        ...
                        <?php echo form_open('adminpanel/webtasks/edited'); ?>

                            <input type="hidden" name="id" value="<?php echo $edit['id']; ?>">

                            <div class="form-group">
                                <label for="textTitle">Enter Title For Text</label>
                                <input type="text" name="textTitle" class="form-control" value="<?php echo $edit['title']; ?>">
                            </div>
                            <div class="form-group">
                            <label for="textDesp">Enter Description Here</label>
                            <textarea class="form-control" name="textDesp" style="height:250px;"><?php echo $edit['desp']; ?>       </textarea>
                            </div>
