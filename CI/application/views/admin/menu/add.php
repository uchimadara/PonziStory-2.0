<div class="col-md-12">
    <div class="tile">
        <h2 class="tile-title">Add menu item</h2>
        ...
        <div id="cms_menuForm" class="p-10">
            ...
            <div class="formContainer">
                ...
                <div class="form-group">
                    ...
                    <?= form_dropdown('place', $this->picklist->select_values('cms_menu_list'), '', 'class="form-control"') ?>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <?= form_dropdown('parent_id', $this->picklist->select_values('cms_menu_parent_list', TRUE), '', 'class="form-control"') ?>
                </div>
                <div class="form-group">
                    <label for="name">Icon:</label>
                    <?= form_dropdown('icon', $this->picklist->select_values('css_icon_list'), '', 'class="form-control"') ?>
                </div>
