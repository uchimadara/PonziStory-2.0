...
<html>
<head>
<title><?php echo $tasks['websitename']; ?></title>
    ...
    <aside id="sidebar">
        ...
        <div class="side-widgets overflow">
            ...
            <div class="text-center s-widget m-b-15" id="profile-menu">
                ...
                <h2 class="username tile"><?php echo $tasks['username']; ?></h2>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="col-md-12">
                        ...
                        <?php echo form_open('adminpanel/webtasks'); ?>

                            <div class="form-group">
                                <label for="textTitle">Enter Title For Text</label>
                                <input type="text" name="textTitle" class="form-control">
                            </div>
                            <div class="form-group">
                            <label for="textDesp">Enter Description Here</label>
                            <textarea class="form-control" name="textDesp" style="height:250px;"></textarea>
                            </div>
                            <input type="submit" name="submit" class="btn btn-md btn-info" value="Submit Task">
                        <?php echo form_close(); ?>
                ...
                <div class="col-sm-12 col-md-12">
                    <table class="table">
                        ...
                        <tbody>
                           <?php foreach ($tasks['alltasks'] as $taskss) {
                               ?>

                               <?php $desp = $taskss->description;

                                    $desptoshow = substr($desp, 0, 50);

                                ?>
                               <tr>
                                   <td><?php echo $taskss->id; ?></td>
                                    <td><?php echo $taskss->title; ?></td>
                                     <td><?php echo $desptoshow; ?></td>
                                     <td><?php echo form_open('adminpanel/webtasks/edittasks'); ?>
                                     <input type="hidden" name="idfortaskedit" value="<?php echo $taskss->id; ?>">
