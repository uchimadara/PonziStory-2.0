...
<html>
<head>
<title><?php echo $prize['websitename']; ?></title>
...
<section id="main" class="p-relative" role="main">
    ...
    <aside id="sidebar">
        ...
        <div class="side-widgets overflow">
            ...
            <div class="text-center s-widget m-b-15" id="profile-menu">
                ...
                <h2 class="username tile"><?php echo $prize['username']; ?></h2>
    ...
    <section id="content" class="container">
        ...
        <div id="widgetArea" class="block-area" style="min-height:650px;    margin-bottom: 20px;">
            <div class="row">
                <?php echo form_open('adminpanel/changeadprice'); ?>
                    <div class="form-group">
                        <label for="changeprice">Enter New Price For Ad Pack</label>
                        <input type="text" name="changeprice" class="form-control">
                    </div>
                    <input type="submit" name="changepricebtn" class="btn btn-md btn-info">
                <?php echo form_close(); ?>


            <h4>Your Current Ad Pack Prize Is : <?php echo $prize['price']; ?> BTC</h4>
            </div>
        </div>
