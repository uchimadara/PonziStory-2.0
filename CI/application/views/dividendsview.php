...
<html>
<head>
<title><?php echo $dividends['websitename']; ?></title>
...
<header id="header" class="media">
    ...
    <?php echo $dividends['websitename']; ?>
    </a>
    ...
    <aside id="sidebar">
        ...
        <div class="side-widgets overflow">
            ...
            <div class="text-center s-widget m-b-15" id="profile-menu">
                ...
                <h2 class="username tile"><?php echo $dividends['username']; ?></h2>
        ...
        <div id="widgetArea" class="block-area" style="min-height:650px;    margin-bottom: 20px;">
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    ...
                    <?php echo form_open('adminpanel/dividends'); ?>

                        <div class="form-group">
                        <label for="dividend_amount">Enter $ Amount For Dividents</label>
                            <input type="text" name="dividend_amount" class="form-control" placeholder="for example: 10$">
                        </div>

                        <input type="submit" name="submit" class="btn btn-md btn-danger">

                    <?php echo form_close(); ?>


                    <div alert alert-warning>
                        Total Numbers Of Royalty Shares Are <?php echo $dividends['total_number_of_shares']; ?>
                    </div>
